...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'seedream7649@buxiuzhixing.onmicrosoft.com',
  ...
  protectedRoutes: ['/XXX', '/🥟 Some test files/Protected route'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'mailto:postmaster@seedream7649.top',
